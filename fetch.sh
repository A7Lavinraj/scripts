...
def make_samples(): # for wirting samples in file
    ...
    if len(sample_list) == 2:
        ...
        with open("in", "w") as file: # start appending testcases line by line (input samples)
        ...
        with open("exp", "w") as file: # start appending testcases line by line (output samples)
        ...
        for index in range(0, len(sample_list), 2): # start appending testcases line by line (input samples)
            with open(f"in{int(index / 2) + 1}", "w") as file:
        ...
        for index in range(1, len(sample_list), 2): # start appending testcases line by line (ouput samples)
            with open(f"out{int(index / 2) + 1}", "w") as file:
